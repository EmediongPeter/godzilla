...
export default function HeroSection({}: Props) {
  return (
    <section className="relative h-screen bg-gradient-to-b from-black via-zinc-950 to-black overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute w-full h-[2px] bg-gradient-to-r from-transparent via-[#43e97b] to-transparent opacity-30 blur-sm"
             style={{top: '20%', transform: 'translateY(-50%) rotate(-5deg)'}} />
        <div className="absolute w-full h-[2px] bg-gradient-to-r from-transparent via-[#38f9d7] to-transparent opacity-20 blur-sm"
